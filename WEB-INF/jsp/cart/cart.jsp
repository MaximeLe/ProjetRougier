		...
		<div id="content" class="panier">
				<div id="conteneur_ariane">
					<div id="etapes">
						...
						<img class="onglet1" src="${contextPath}/resources/${codeIsoLang}/img/cart/panier_onglet_1.png" width="20" height="20" alt="<spring:message code="delivery.commande"/>"/>
						<span class="actif"><spring:message code="tunnel.ariane.panier"/></span>
						<div class="etapes_separations"></div>
						<img class="onglet2" src="${contextPath}/resources/${codeIsoLang}/img/cart/panier_onglet_2.png" width="20" height="20" alt="<spring:message code="delivery.livraison"/>"/>
						<span><spring:message code="tunnel.ariane.livraison"/></span>
						<div class="etapes_separations"></div>
						<img class="onglet3" src="${contextPath}/resources/${codeIsoLang}/img/cart/panier_onglet_3.png" width="20" height="20" alt="<spring:message code="delivery.payement"/>"/>
...
<tiles:putAttribute name="moreJS">
	...
	<script src="${contextPath}/resources/js/cart/cart.js" type="text/javascript"></script><script type="text/javascript">
