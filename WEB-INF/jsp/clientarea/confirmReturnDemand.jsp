...
<tiles:insertDefinition name="templateMenu">
	<tiles:putAttribute name="title"><spring:message code="order.confirmationDemandeRetour"/></tiles:putAttribute>
	<tiles:putAttribute name="description"><spring:message code="order.confirmationDemandeRetour"/></tiles:putAttribute>
	...
	<tiles:putAttribute name="breadcrumb">
		||&nbsp;<a href="/"><spring:message code="breadcrumb.accueil"/></a>&nbsp;&gt;<span class="lien_chemin"><spring:message code="order.confirmationDemandeRetour"/></span>
	</tiles:putAttribute>
		...
		<div id="clients" class="mes_retours">
			...
			<div id="returnDetails">
				<div class="coordonnees">
					...
					<h2><spring:message code="order.confirmationDemandeRetour"/>&nbsp;-&nbsp;<spring:message code="order.commandeNum"/>${order.numOrderBiz}&nbsp;<spring:message code="order.du"/><fmt:formatDate value="${order.dateOrder}" pattern="dd/MM/yyyy" /></h2>
				</div>
