...
<tiles:insertDefinition name="templateMenu">
	<tiles:putAttribute name="title"><spring:message code="clientAreaMenu.monMagasinPrefere"/></tiles:putAttribute>
	<tiles:putAttribute name="description"><spring:message code="clientAreaMenu.monMagasinPrefere"/></tiles:putAttribute>
	...
	<tiles:putAttribute name="breadcrumb">
		...
		<span class="lien_chemin"><spring:message code="clientAreaMenu.monMagasinPrefere"/></span>
	</tiles:putAttribute>
		...
		<div id="clients" class="magasin_prefere">
			<div id="contenu_interieur">
						...
						<div class="coordonnees">
							<h2>
								<spring:message code="clientAreaMenu.monMagasinPrefere"/>
							...
							<div class="bloc_droit_et_gauche">
								...
								<div class="bloc_droit">
									...
									<div class="recherch_mag">
										...
										<form:form commandName="searchShop" method="post" action="">
									...
									<c:choose>
										<c:when test="${noShop}">
											<div id="zipcode_error" class="error"><spring:message code="favoriteShop.mauvaisCodePostal"/></div>
										</c:when>
										
										<c:when test="${noMapShop}">
											<div id="zipcode_error" class="error"><spring:message code="favoriteShop.aucunMagasinRegion"/></div>
										</c:when>
										
										<c:otherwise>
											<c:choose>
												<c:when test="${not empty shopList || not empty mapShopList}">
													<h3><spring:message code="favoriteShop.magasinsTrouves"/><span class="rouge">&nbsp;*</span></h3>
													<form action="?action=setShop" method="post">
	...
	<tiles:putAttribute name="moreJS">
		<script>
			$("#menu .contenu_menu ul:eq(0) li:eq(4) a").attr("style","color:#000000;");
			$("#menu .contenu_menu ul:eq(0) li:eq(4) a").removeAttr("href");
		</script>
