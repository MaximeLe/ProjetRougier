				...
				<div class="contenu_blanc">
					...
					<c:if test="${!empty orderList}">
						...
						<c:forEach items="${orderList}" var="order" varStatus="status">
							...
							<!-- Attention une boucle de 5 lignes maximum au chargement de la page, changement après un clic sur voir toutes mes commandes -->
						...
						<!-- à mettre uniquement si 5 lignes (au chargement de la page) -->
