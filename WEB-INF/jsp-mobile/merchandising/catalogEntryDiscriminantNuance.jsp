						...
						<div class="grey">
							...
							<div class="nuanceQuantity_${nuance.ceId}">
								<div class="select">
									...
									<input type="text" id="nuanceQuantity_${nuance.ceId}" value="0" maxlength="4" onBlur="incQuantityKey(${nuance.ceId});" onkeypress="if (event.keyCode == 13){incQuantityKey(${nuance.ceId});}">
									<img onClick="incQuantity(${nuance.ceId});" src="${contextPath}/resources/${codeIsoLang}/img/merchandising/btn_plus.png" width="15" height="15" alt="" border="0"/>
								</div>
