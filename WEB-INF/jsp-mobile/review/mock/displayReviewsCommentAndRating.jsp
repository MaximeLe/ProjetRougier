...
<br />
<br />
</div><br/><div id="corps2">
<ul id="tabnav">
     <li ><a href="?action=displayReviews&classId=${classId}&objectInstanceId=${objectInstanceId}&subClassId=${subClassId}&langueId=${langueId}&finderType=random">Affichage complet des avis</a></li>
     <li ><a href="?action=displayReviews&classId=${classId}&objectInstanceId=${objectInstanceId}&subClassId=${subClassId}&langueId=${langueId}&finderType=random&view=reco">Affichage des recommendations</a></li>
     <li class="active"><a href="#">Affichage des commentaires et notes</a></li>
