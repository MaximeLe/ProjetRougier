...
<c:set var="bannerStyle">
	<c:if test="${(context.instanceType) == 'STORE_PREVIEW'}">
		body {background-image:url('${contextPath}/resources-mobile/${codeIsoLang}/img/StarterStore/Background_orange.jpg'); background-repeat:repeat-x;}
		#global {margin-top:34px;}
		#headerBG {top:34px;}
	</c:if>
</c:set>
...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="fr" lang="fr">
	<head>
		...
		<tiles:insertAttribute name="webmasterTools" ignore="true"/>
